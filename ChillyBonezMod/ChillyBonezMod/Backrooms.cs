...
namespace ChillyBonezMod
{
  public static class Backrooms
  {
    ...
    public static void Setup()
    {
      ...
      Backrooms.Assets = AssetBundle.LoadFromMemory(ResourceLoader.ResourceBinary("baloney"));
      Backrooms.Yarn = Backrooms.Assets.LoadAsset<YarnProgram>("Assets/Rooms/chillyfools.yarn");
